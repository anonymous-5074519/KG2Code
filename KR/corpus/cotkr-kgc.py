...
Reason 1: I need to know the background information about X-Alfonso.
Knowledge 1: X-Alfonso is associated with the genre of jazz fusion. X-Alfonso is the composer of "Habana Blues".

Your task is to summarize the relevant information that is helpful to predict the missing part of the triple from the following subgraph. Please think step by step and iteratively generate the reasoning chain and the corresponding knowledge.
...
Reason 1: I need to know the location of Karwacja.
Knowledge 1: Karwacja is located in Poland.
...
Reason 1: I need to know the background information about "Hello World".
Knowledge 1: "Hello World" is an album performed by "Scandal", with lyrics in Japanese. 
Reason 2: I need to know more about "Hello World".
Knowledge 2: Additionally, it is part of a sequence of works, being followed by "Yellow" and preceded by "Standard".
...
kr_prompt1='''Your task is to summarize the relevant information that is helpful to predict the missing part of the triple from the following subgraph. Please think step by step and iteratively generate the reasoning chain and the corresponding knowledge.
Subgraph: {subgraph}
Triple: {triple}
'''
